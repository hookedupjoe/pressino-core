...
<head>
  ...
  <meta name="viewport"
    ...
    <base href="<?php echo PRESSINO_PLUGIN_URL . '/apps/DevDesigner/' ?>" >



  <link rel="stylesheet" href="<?php echo PRESSINO_PLUGIN_CORE_LIB_URL ?>/built-lib/support-libs.css">
  ...
  <!-- Local app css -->
  <link rel="stylesheet" href="<?php echo PRESSINO_PLUGIN_URL ?>/apps/DevDesigner/app/css/app.css">
  <style>
    .subdemo1 {
      color: red;
    }
...
<body>
  ...
  <script src="<?php echo PRESSINO_PLUGIN_CORE_LIB_URL ?>/lib/ace/ace.js"></script>
  <script src="<?php echo PRESSINO_PLUGIN_CORE_LIB_URL ?>/lib/ace/addons/actapp-ace-plugin.js"></script>
  <script src="<?php echo PRESSINO_PLUGIN_CORE_LIB_URL ?>/lib/ace/ext-language_tools.js"></script>
  <script src="<?php echo PRESSINO_PLUGIN_CORE_LIB_URL ?>/lib/ace/ext-beautify.js"></script>

  <!-- Application Launch Script -->
  <script src="<?php echo PRESSINO_PLUGIN_URL ?>/apps/DevDesigner/app/app.js"></script>
