...
( function ( wp,  ActionAppCore) {
    ...
    function initBlockEditor(){
        ...
        BlockEditor.getControlIcon = function(theControlName){
            if( theControlName  == 'spot'){
                return el('svg', { width: 80, height: 80 },
                    [el('rect', { x:"5.4962", y:"7.1616", width:"10.263", height:"6.811", fill:"#1c71b0", stroke:"#000", "stroke-width":".52918"} ),
                    el('rect', { x:"1.7003", y:"4.8881", width:"17.855", height:"11.358", fill:"#fff", stroke:"#000", "stroke-width":".52918" } )
                ]
                );   
            }
