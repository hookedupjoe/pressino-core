...
( function ( blocks, element, serverSideRender, blockEditor ) {
    ...
    var tmpActionName = 'ActAppDynamicDemo:openOptions';
    registerBlockType( 'actappdesign/dynamic-demo', {
        ...
        edit: function ( props ) {
            if( !(ThisApp.actions[tmpActionName]) ){
                ThisApp.actions[tmpActionName] = function(theParams, theTarget){
                ...
                el(InspectorControls,
                    ...
                    wp.element.createElement(wp.components.PanelBody, {
                        ...
                        el('form',{className:'ui form segment slim'},[
                            ...
                            el('div',{action:tmpActionName, tempClientId: props.clientId, className:'ui button fluid blue'},'Click Me!'),
